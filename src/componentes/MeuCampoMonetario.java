...
public class MeuCampoMonetario extends MeuJTextField implements CaretListener {
    protected boolean permiteNegativo;
    
    public MeuCampoMonetario(boolean obrigatorio, String dica, boolean permiteNegativo, int colunas) {
        super(obrigatorio, dica, colunas,"");
