...
public class MeuCampoInteiro extends MeuJTextField implements MeuComponente, CaretListener {
    protected boolean permiteNegativo;

    public MeuCampoInteiro(boolean obrigatorio, String dica, Integer tamanho, boolean permiteNegativo) {
        super(obrigatorio, dica, (tamanho == null ? 15 : tamanho),"");
